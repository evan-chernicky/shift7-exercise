...
function TopHeader({cartNumber, setCartNumber}) {
  ...
  return (
    <div className="w-full flex justify-between text-white h-9 relative z-10">
        ...
        <button onClick={() => setCartNumber(cartNumber + 1)}  className="flex flex-row items-center hover:text-black focus:text-black duration-300 px-3 bg-red">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
